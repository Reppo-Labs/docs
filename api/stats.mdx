...
<Note>
This endpoint is currently available without authentication. Use the protected `GET /stats/summary` endpoint for production integrations where you need a stable, authenticated version of these metrics.
</Note>
