...
`GET `https://reppo.ai/api/v1/public/pods/search?q=[Q]&limit=[L]&filters=[SUBNET_ID]' 
...
```bash
curl --location 'https://reppo.ai/api/v1/public/pods/search?q=[Q]&limit=[L]&filters=[SUBNET_ID]' \
--header 'Content-Type: application/json'
```
