...
Tweets can be minted as on-chain NFTs on Base through the `POST /pods/mint` endpoint on the Chat Server (`https://api.reppo.xyz`). The minting process runs automatically:
