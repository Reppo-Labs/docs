...
<Note>
  In Reppo V1, the docs referred to public and private "subnets." In Reppo V2, that split was replaced by permissionless datanet creation with owner-controlled access and economics. Anyone can launch a datanet, and each datanet decides how participation works.
</Note>
