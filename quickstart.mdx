...
<CardGroup cols={2}>
  <Card title="Create a Datanet" icon="network-wired" href="/guides/create-datanet">
    Configure and launch your own data market on Base, with custom fees, rules, and emissions.
  </Card>
  ...
  <Card title="Claim Emissions" icon="coins" href="/guides/claim-emissions">
    Check your pods' per-epoch REPPO emissions and claim them on-chain.
  </Card>
  <Card title="Agent Integration" icon="robot" href="/guides/agent-integration">
    Register an automated agent to discover datanets, mint pods, and claim emissions.
  </Card>
